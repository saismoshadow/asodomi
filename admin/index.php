...
// Soci, utenti e newsletter: solo amministratori (i redattori gestiscono solo il blog)
$solo_admin = [
...
// Azioni POST/GET speciali ed export: girano SENZA layout (redirect o file)
$senza_layout = [
