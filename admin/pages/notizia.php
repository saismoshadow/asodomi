...
<form method="post" action="<?= e(admin_url('salva-notizia')) ?>" class="form panel-form" enctype="multipart/form-data">
    ...
    <label>Testo *
        <textarea name="testo" rows="6" required
                  placeholder="Scrivi la notizia in stile giornalistico. Puoi usare il testo semplice (i paragrafi vengono creati automaticamente) oppure un po' di HTML: &lt;h2&gt;, &lt;strong&gt;, &lt;em&gt;, &lt;ul&gt;, &lt;li&gt;, &lt;a href=...&gt;."><?= e($nt['testo'] ?? '') ?></textarea>
    </label>
