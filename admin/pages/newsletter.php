...
<div class="admin-header">
    ...
    <a class="btn btn-primary" href="<?= e(admin_url('newsletter_nuova')) ?>"><?= e($t['newsletter']['nuova_campagna'] ?? 'Nuova campagna') ?></a>
</div>
...
<table class="admin-table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-sm" href="<?= e(admin_url('newsletter_nuova') . '&id=' . $c['id']) ?>"><?= e($t['newsletter']['modifica'] ?? 'Modifica') ?></a>
                <?php if ($c['stato'] === 'bozza'): ?>
                    <a class="btn btn-sm btn-primary" href="<?= e(admin_url('newsletter_nuova') . '&id=' . $c['id']) ?>"><?= e($t['newsletter']['programma'] ?? 'Programma invio') ?></a>
                <?php endif; ?>
                <form method="post" action="<?= e(admin_url('newsletter_elimina')) ?>" style="display:inline" onsubmit="return confirm('<?= e($t['newsletter']['conferma_elimina'] ?? 'Eliminare questa campagna?') ?>');">
                    <?= csrf_campo() ?>
