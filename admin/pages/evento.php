...
<form method="post" action="<?= e(admin_url('salva-evento')) ?>" class="form panel-form" enctype="multipart/form-data">
    ...
    <label>Descrizione
        <textarea name="descrizione" rows="5"
                  placeholder="Descrivi l'evento: programma, orari, come partecipare... Puoi usare il testo semplice (i paragrafi vengono creati automaticamente) oppure un po' di HTML: &lt;h2&gt;, &lt;strong&gt;, &lt;em&gt;, &lt;ul&gt;, &lt;li&gt;, &lt;a href=...&gt;."><?= e($ev['descrizione'] ?? '') ?></textarea>
    </label>
